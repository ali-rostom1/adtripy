          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8">
                ...
                <button className="group inline-flex items-center justify-center space-x-3 border-2 border-green-400 text-green-400 px-8 py-4 font-semibold tracking-wider uppercase text-sm hover:bg-green-400 hover:text-black transition-all duration-300">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-green-500/10 to-green-600/5 rounded-2xl p-6 border border-green-500/20">
                      <div className="flex items-center justify-between mb-4">
                        <h4 className="text-green-400 font-semibold text-sm tracking-wider uppercase">
                          Monthly Earnings
                        </h4>
