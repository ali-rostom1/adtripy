              ...
              {vehicles.length === 0 ? (
                <div className="text-center py-16 sm:py-24 px-4">
                  ...
                  <p className="text-gray-600 mb-6 sm:mb-8 max-w-md mx-auto text-sm sm:text-base">
                    Adjust your search criteria or be the first to list a vehicle
                    in this area.
                  </p>
                  <Link
                    to="/cars/create"
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-6 lg:p-8 flex-1">
                          ...
                          <p className="text-gray-600 leading-relaxed mb-6 sm:mb-8 line-clamp-3 text-sm sm:text-base">
                            {vehicle.description ||
                              "A premium vehicle with excellent condition and features, offering an exceptional driving experience for your journey."}
                          </p>
